...
const basicPgn = function (boardId, configuration) {
    let baz = pgnBase(boardId, Object.assign({mode: 'view'}, configuration))
    return {pgn: baz.getPgn()}
}
...
export {pgnBoard, pgnEdit, pgnBase, pgnPrint, pgnView, basicPgn}